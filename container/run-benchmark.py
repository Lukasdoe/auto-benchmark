        ...
        for i in range(200):
            ...
            if judged_execution_times.stable and judged_compilation_times.stable:
                results["queries"][query_file.replace(".sql","")] = {
                    ...
                    "execution_time_summary": f"{judged_execution_times.estimate_ms:.3f} ms ± {judged_execution_times.plus_minus_ms:.3f} ms",
                    "compilation_time_summary":  f"{judged_compilation_times.estimate_ms:.3f} ms ± {judged_compilation_times.plus_minus_ms:.3f} ms",
                }
                break
